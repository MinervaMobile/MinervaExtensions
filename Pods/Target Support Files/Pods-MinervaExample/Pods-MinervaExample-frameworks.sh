...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MinervaCoordinator/MinervaCoordinator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MinervaList/MinervaList.framework"
